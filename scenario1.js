...
try {
    (async () => {
        ...
        await page.screenshot({ path: 'scenario1-Screenshot-1.png' })
        ...
        await page.screenshot({ path: 'scenario1-Screenshot-2.png' })
        ...
        await page.screenshot({ path: 'scenario1-Screenshot-3.png' })
        ...
        await page.screenshot({ path: 'scenario1-Screenshot-4.png' })
        ...
        console.log("Value ===> "+actualEligibleLoanAmount);

        await page.screenshot({ path: 'scenario1-Screenshot-5.png' })

        assert.equal(actualEligibleLoanAmount,userData.estimatedLimit)
